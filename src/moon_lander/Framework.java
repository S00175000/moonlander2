    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            ...
            case MAIN_MENU:
                ...
                g2d.drawString("Use up, right,left keys to controle the rocket.", frameWidth / 2 - 117, frameHeight / 2);
                g2d.drawString("1 - Easy     2 - Normal     3 - Hard", frameWidth / 2 - 100, frameHeight / 2 + 15);
                g2d.drawString("Press any key to start the game.", frameWidth / 2 - 90, frameHeight / 2 + 30);
